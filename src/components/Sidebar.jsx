...
const Sidebar = () => {
    ...
    return (
      <>
      <div className="px-6 py-3 2xl:px-3 bg-gray-50 text-black text-center lg:text-left">
        {/* <div className="container mx-auto xl:px-32"> */}
            <div className="mt-12 lg:mt-0 mb-96">
                     <aside class="w-64 h-96" aria-label="Sidebar">
                     <div class="px-3 py-64 overflow-y-auto rounded bg-gray-50 dark:bg-gray-800 mb-80">
                            <ul class="space-y-2">
                            <li>
