      ...
      <div className="-mt-96 ml-80 mr-80">
        <div className="h-screen overflow-y-auto rounded bg-gray-50 dark:bg-gray-800 -mr-80 -ml-0">
          <div className="sideright">
            <div className="mt-20 ml-55 font-cinzel font-bold text-xl">
              Title
            </div>
            <div className="flex flex-col gap-42 text-center">
              <input type="text" placeholder="Title" required></input>
              <div className="-mt-35 -mb-40 -ml-720 font-cinzel font-bold text-xl">
                Description
              </div>
              ...
              <input type="text" placeholder="Upload Image"></input>
            </div>
